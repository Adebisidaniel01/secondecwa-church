  ...
  const ministries = [
    {
      ...
      contact: "youth@heartchurch.org",
      activities: ["Youth Group", "Summer Camp", "Mission Trips", "Game Nights"],
      featured: true
    },
    {
      id: 2,
      ...
      leader: "Miss Jennifer Parker",
      contact: "kids@heartchurch.org",
    ...
    },
    {
      ...
      contact: "worship@heartchurch.org",
    ...
    },
    {
      ...
      contact: "outreach@heartchurch.org",
      activities: ["Food Bank", "Homeless Ministry", "Prison Ministry", "Senior Care"],
      featured: false
    },
    {
      id: 5,
      name: "Adult Education",
      description: "Providing opportunities for spiritual growth and biblical learning through Bible studies, seminars, and discussion groups.",
      icon: BookOpen,
      ageGroup: "Adults",
      meetingTime: "Wednesdays 7:00 PM",
      location: "Classroom A",
      leader: "Pastor Michael Thompson",
      contact: "education@heartchurch.org",
      activities: ["Bible Study", "Sunday School", "Seminars", "Book Clubs"],
      featured: false
    },
    {
      id: 6,
    ...
    },
    {
      ...
      contact: "hospitality@heartchurch.org",
      activities: ["Greeters", "Coffee Ministry", "Event Catering", "Welcome Team"],
      featured: false
    },
    {
      id: 9,
      name: "Missions",
      description: "Supporting local and global missions through prayer, financial support, and sending teams to serve in communities around the world.",
      icon: Globe,
      ageGroup: "All Ages",
      meetingTime: "Monthly meetings",
      location: "Mission Center",
      leader: "Dr. Robert Kim",
      contact: "missions@heartchurch.org",
      activities: ["Local Missions", "Global Missions", "Mission Trips", "Support Teams"],
      featured: false
    }
  ];
